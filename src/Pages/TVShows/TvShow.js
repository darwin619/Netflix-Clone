...
class TvShow extends React.Component {
	...
	componentDidMount() {
		...
		setTimeout(() => {this.setState({firstLoad: !this.state.firstLoad})}, 10);
		setTimeout(() => {this.setState({secondLoad: !this.state.secondLoad})}, 500);
		setTimeout(() => {this.setState({thirdLoad: !this.state.thirdLoad})}, 700);
	}
