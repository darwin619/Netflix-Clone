        ...
        <div className="item-page-footer">
    		<div className="item-page-container">
          {
            ...
            ? (movieCast
              ...
              .map(({id, profile_path, ...otherProps}) => profile_path ? (<ItemPageCast key={id} profile_path={profile_path} {...otherProps} />) : null))
            : null
          }
        {
        ...
        <div className="buttons">
          {
            ...
            ? (<button className="btn" 
              onClick={() => removeItem(item)}><FontAwesomeIcon icon={faCheck} className="icon" />Added To List</button>)
            : (<button className="btn" 
              onClick={() => addItem(item)}><FontAwesomeIcon icon={faPlus} className="icon" />My List</button>)
          }
